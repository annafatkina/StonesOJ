...
//----------------------------------------------------------------------
#define ANN_POW1(v)		fabs(v)
#define ANN_ROOT1(x)		(x)
...
//----------------------------------------------------------------------
#define ANN_POWp(v)		powf(fabs(v),(float)ANN::MetricPower)
#define ANN_ROOTp(x)		powf(fabs(x),1.f/(float)ANN::MetricPower)
